...
class Auction:
    ...
    def parsing(self):  # парсинг из csv в список и предварительная обработка лотов
    ...
    def export_data(self):  # возвращает список со всей инфой о каждом актуальном лоте
        x = []
